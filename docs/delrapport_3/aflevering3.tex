...
We are in the very fortunate position that we work at the same place of our target group, this allows us to do Hallway testing exceptionally easy, these tests has already aided in the interface design process. % Om folk forstod at skrive sin KU-ID korrekt ind.
