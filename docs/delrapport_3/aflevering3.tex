...
begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{pictures/screenshots/kuid}
\caption{Landing page on dikukeys.dk. This is where the user enters their KU ID.}
\label{fig:ss_kuid}
\end{figure}
begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{pictures/screenshots/email}
\caption{The webmail interface of KU. The registration email has been received by the user.}
\label{fig:ss_email}
\end{figure}
begin{figure}[H]
\centering
\includegraphics[width=0.5\textwidth]{pictures/screenshots/publickey}
