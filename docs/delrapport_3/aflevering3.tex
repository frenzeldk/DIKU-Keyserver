...
\title{
\vspace{3cm}
\Large{Third Partial Assignment - ProjDat}
}
...
\item \textbf{R}esponsibility: The system's main responsiblity is to maintain a table with a mapping from KU Usernames to corresponding OpenPGP public keys. It must also allow other privileged software and privileged users to read from this table.
\end{itemize}
...
\item The KU usernames registered in this system must \textbf{not} be accessible for non-privileged users and software.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{pictures/sequence_diagram_upload_new}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{pictures/sequence_diagram_replace_new}
